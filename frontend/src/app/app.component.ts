        ...
        if (this.tickerContainer) {
            ...
            script.innerHTML = JSON.stringify({
                "symbols": [
                    ...
                    { "description": "Soja", "proName": "CBOT:ZS1!" },
                    { "description": "Trigo", "proName": "CBOT:ZW1!" },
                    { "description": "Café", "proName": "ICEUS:KC1!" },
                    { "description": "Maíz", "proName": "CBOT:ZC1!" },
                    { "description": "Cacao", "proName": "ICEUS:CC1!" },
                    { "description": "Azúcar", "proName": "ICEUS:SB1!" },
                    { "description": "Jugo de Naranja", "proName": "ICEUS:OJ1!" },
