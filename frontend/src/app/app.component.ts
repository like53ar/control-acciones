        ...
        if (this.tickerContainer) {
            ...
            script.innerHTML = JSON.stringify({
                "symbols": [
                    ...
                    { "description": "Soja", "proName": "CBOT:ZS" },
                    { "description": "Trigo", "proName": "CBOT:ZW" },
                    { "description": "Maíz", "proName": "CBOT:ZC" },
                    { "description": "Café", "proName": "ICEUS:KC" },
                    { "description": "Cacao", "proName": "ICEUS:CC" },
                    { "description": "Azúcar", "proName": "ICEUS:SB" },
                    { "description": "Jugo de Naranja", "proName": "ICEUS:OJ" },
